...
var HTMLbioPic = '<a href="#"><img src="%data%" class="biopic img-responsive center-block" alt="Portrait of Bert Ciccone"></a>';
...
var HTMLprojectImage = '<img class="project-image" src="%data%" alt="Screenshot of project">';
